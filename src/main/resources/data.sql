...
INSERT INTO peserta_bpjs
    (jmlkeluarga, nama, nmcabang, noka, nova)
VALUES
...
INSERT INTO info_autodebet
    (idhead, jmlkeluarga, kdasalpremi, kdbank, nama, namapic, nmbank, nmcabang, noka, nokapic, nokk, norekening, nova, premi, status_, tgl_input)
VALUES
    (0, 2, 0, 'PBMDR01', 'Rizki Saja', 'PIC X', 'MANDIRI', 'CIKARANG', '0001265125534', '0001265125512', '1231231233452', '1111112222', '8888801265125534', 0, 0, '17-08-2020'),
    (0, 4, 0, 'PBMDR02', 'Fani Aja', 'PIC Z', 'MANDIRI', 'BEKASI', '0001265125535', '0001265125513', '1231231233455', '3334443342', '8888801265125535', 0, 1, '19-04-2019');
